...
<div class="flex h-screen w-full">
	<div class="bg-hero flex-1 bg-[url('https://media.timeout.com/images/101456795/1372/772/image.jpg')] bg-cover bg-center bg-no-repeat">
		<div class="container mx-auto px-4">
			<div class="flex h-screen items-center justify-center">
				<div class="max-w-xl w-full rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-800">
					...
					<button
						...
						on:click={() => (yeezyTweet = getRandomTweet())}
					>
						New Tweet
					</button>
				</div>
